...
class SoftPhoneVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        print (self.sip_login as String)
        print (self.sip_pass as String)
        ...
        queue.async{
            self.start_pjsip(sip_l: self.sip_login as String, sip_p: self.sip_pass as String)
        }
    ...
    func start_pjsip (sip_l: String, sip_p: String) {
        ...
        let fullURL = ("sip:" + sip_l + "@92.50.152.146:5401" as NSString).utf8String
        
        let uri = ("sip:" + sip_l + "@92.50.152.146:5401;transport=UDP" as NSString).utf8String
        let realm = ("*" as NSString).utf8String
        let username = (sip_l as NSString).utf8String
        let password = (sip_p as NSString).utf8String
